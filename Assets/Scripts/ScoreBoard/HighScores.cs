...
{
    const string privateCode = "X7tUbD6oJk2jEkP_0FCJ0QELJoNH1CqU6IXqiMN8RS4g";  //Key to Upload New Info
    const string publicCode = "62863a938f40bb11c0521307";   //Key to download
